...
// NOTE: PDF signature insertion now handled by insertSignaturesIntoPDF.js
...
// NOTE: PDF signature insertion endpoint available at /documents/insert-pdf-signatures
...
// Flatten PDF endpoint for Step 4 completion
server.post('/api/flatten-pdf', async (request, reply) => {
  try {
    ...
    // The PDF form fields are automatically flattened when we save without the form
    // This makes signatures non-editable and permanently embedded
